...
public class PublicRidesAdapter extends BaseAdapter {
	private ArrayList<Ride> arrayList;
	...
	public void init(Context context, ArrayList<Ride> arrayList, Tracker tracker) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.item_public_grp_rides_x,
					parent, false);
		...
		if (arrayList.get(position).getSeats() != null)
			holder.seatstext.setText("Total seats : "
					+ arrayList.get(position).getSeats());
		if (arrayList.get(position).getRemainingSeats() != null)
			holder.tvRemainingSeats.setText("Remaining seats : "
					+ arrayList.get(position).getRemainingSeats());*/
		...
		holder.tvJoinNow.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				tracker.send(new HitBuilders.EventBuilder()
						.setCategory("Join Ride")
						.setAction("Join Ride  pressed")
						.setLabel("Join Ride").build());

				Ride rideDetailsModel = arrayList.get(position);
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				/*if (rideDetailsModel.getRideType().equals(
						NewHomeScreen.CAR_POOL_ID)) {
					mobileNumber = rideDetailsModel.getMobileNumber();
				} else if (rideDetailsModel.getRideType().equals(
						NewHomeScreen.SHARE_CAB_ID)) {
					mobileNumber = rideDetailsModel.getMobileNumber();
				}*/
	...
	/*private class ViewHolder {
		private TextView tvRideOwnerName, seatstext, tvRemainingSeats,
				datetext, timetext;

...
public class StringTags {
	...
	public static String TAG_WHERE_LIVE = "Where do you live?";
	...
	public static String TAG_DOES_NOT_HAVE_MEMBER = "This club does not have any members, choose one with members";

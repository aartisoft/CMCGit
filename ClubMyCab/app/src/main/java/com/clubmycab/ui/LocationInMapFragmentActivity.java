		...
		protected void onPostExecute(Void v) {
			...
			if (routeresponse == null) {
				...
				try {
					...
					sharelocationmap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
						@Override
						public boolean onMarkerClick(Marker marker) {
							try{
								...
								geocoder = new Geocoder(LocationInMapFragmentActivity.this, Locale.getDefault());
								...
								sharelocationtext.setText(address+","+city+","+country);
							}catch (Exception e){
								e.printStackTrace();
							}
							return false;

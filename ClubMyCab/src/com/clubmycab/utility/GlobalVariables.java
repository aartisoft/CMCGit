...
public class GlobalVariables {
	...
	// "http://104.155.193.222/cmc/cmcservice"; // GoogleCloudProduction
	...
	// "ahKQMpBZmCYVwYpPMG9CVgrN9H6K9MgC"; // GoogleCloudProduction
	// public static final String ShareThisAppLink =
	// "https://ishareryde.com/installapp.php"; // GoogleCloudProduction

	// http://ishareryde.com/cmcservice/userData.php

	// Mobikwik
	// public static final String Mobikwik_ServerURL =
	// "https://walletapi.mobikwik.com"; // Production
	// public static final String Mobikwik_Mid = "MBK9572"; // Production
	// public static final String Mobikwik_MerchantName = "iShareRyde"; //
	// Production
	// public static final String Mobikwik_14SecretKey =
	// "bToO0UJ7OaijZ9g7a1Axr3J5OpEF"; // Production
	// public static final String Mobikwik_14SecretKey_TokenRegenerate =
	// "xXgeDsLo1nliS32dlkb21JpC05"; // Production

...
public class RidesAvailableFragment extends Fragment implements OnClickListener{
	...
	public static RidesAvailableFragment getInstance(){
		return fragment;
	}
	...
	public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		...
		lvPublicRides = (ListView)view.findViewById(R.id.lvPublicRides);
		lvPrivateGroup = (ListView)view.findViewById(R.id.lvRidesList);
		adapter = new RidesAvailableAdapter();
		adapter.init(getActivity(), ridesList);
		lvPrivateGroup.setAdapter(adapter);
		fetchInvitations();
	}

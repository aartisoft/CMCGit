...
import com.clubmycab.ListViewAdapter.ViewHolder;
...
public class HomeRidePageFragment extends Fragment{
 ...
 tloc,  tdate,
	...
	public static HomeRidePageFragment newInstance( String floc,
			String tloc, String tdate,
			String ttime, String sets,
			String ownnam,String ownimgnam) {
		
		

		Bundle args = new Bundle();
		args.putString("floc", floc);
		args.putString("tloc", tloc);
		args.putString("tdate", tdate);
		args.putString("ttime", ttime);
		args.putString("sets", sets);
		args.putString("ownnam", ownnam);
		args.putString("ownimgnam", ownimgnam);
...
//Toast.makeText(getActivity(), "call::"+arg2, Toast.LENGTH_SHORT).show();
...
//		
		...
		LinearLayout llCircularHeader=(LinearLayout)convertView.findViewById(R.id.llCircularHeader);
		...
		TextView seatstext = (TextView) convertView.findViewById(R.id.seatstext);
		TextView tvAvSeats=(TextView)convertView.findViewById(R.id.tvAvSeats);
		...
		myridesbannerusername
				.setText(ownnam.trim());
		fromtolocationvalue.setText(floc
				.trim()
				+ " > " + tloc.trim());

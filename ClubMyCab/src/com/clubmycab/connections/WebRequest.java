...
public class WebRequest {
    ...
    // This message only gets visible when the already logged-in user updates the app to v2.5,
    // and HttpsURLConnection fails to establish a trusted connection (SSLException)
    ...
    public void perform(String endpoint, String params) throws WebRequestException {
        ...
        try {
            ...
            } else if (responseCode == HttpURLConnection.HTTP_MOVED_PERM // Handle redirection
